...
{
    LOG_DEBUG("loadLabelName " << locationFilename);
                 ...
                 detect_result_group_t *group)
{
    ...
    for (int i = 0; i < validCount; ++i)
    {
        ...
        LOG_DEBUG("result " << last_count << ": (" << group->results[last_count].box.left << ", " << group->results[last_count].box.top << ", "
